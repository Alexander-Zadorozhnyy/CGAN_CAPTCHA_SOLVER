...
class YMLModel:
    ...
    def set_pre_resnet_model(self):
        base_model = tf.keras.applications.ResNet152(input_shape=self.shape,
                                                     include_top=False,
                                                     weights='imagenet')
    ...
    def save(self, path='trained_models', name='example.h5'):
    ...
    def load(self, name, path='trained_models'):
